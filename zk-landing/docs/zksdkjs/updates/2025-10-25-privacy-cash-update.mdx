...
title: "Privacy Cash Integration Update – October 26, 2025"
sidebar_label: "Oct 25, 2025 – Privacy Cash"
description: "Privacy Cash chosen as Solana privacy provider, replacing Privacy Cash references; implementation progress and roadmap."
...
- **Decision**: Privacy Cash SDK selected as the zkSDK's Solana privacy provider over initial Privacy Cash stub.
...
- **Documentation**: All public-facing references updated from "Privacy Cash" to "Privacy Cash" to reflect strategic direction.
...
While Privacy Cash offers impressive ZK compression (99% cost reduction), Privacy Cash provides stronger privacy guarantees:

| Aspect | Privacy Cash | Privacy Cash |
|--------|-------------|----------------|
| **Privacy Model** | Intent relay + unlinkability | ZK compression (efficiency focus) |
| **Production Status** | ✅ Mainnet, audited | ⚠️ Devnet, evolving |
| **Compliance** | ✅ Built-in domains | ❌ Not emphasized |
| **API Maturity** | ✅ Stable, documented | ⚠️ Rapid iteration |
| **Use Cases** | Private settlements, regulated DeFi | High-volume state compression |

**Decision**: Privacy Cash's production readiness, audit status, and compliance features make it the right choice for zkSDK's privacy-first mission, while Privacy Cash remains an excellent general-purpose compression solution.
...
- ✅ `zk-landing/docs/zksdkjs/overview.md` – Provider status table updated
- ✅ `zk-landing/docs/zksdkjs/provider-comparison.md` – Decision tree and comparison table
- ✅ `zk-landing/docs/zksdkjs/integration-flows.md` – Solana flow references
- ✅ `zk-landing/docs/zksdkjs/architecture.md` – Privacy mechanism descriptions
- ✅ `zk-landing/docs/zksdkjs/agents.md` – Agent recipe references
- ✅ `zk-landing/src/pages/index.js` – Marketing copy and landing page

**Verification**: `rg -i "Privacy Cash"` returns no matches across public documentation (zk-landing repository).
...
1. **Research & Decision**
   - Comparative analysis completed (Privacy Cash vs Privacy Cash vs alternatives)
...
3. **Documentation Migration**
   - All public-facing "Privacy Cash" references replaced with "Privacy Cash"
...
3. **Bridge Wiring**
   - Multi-provider workflows (e.g., Railgun → Privacy Cash cross-chain)
...
- ✅ Basic deposit and balance query
...
- **Provider**: `src/light-provider.ts` – Main `LightProtocolPrivacyProvider` class
- **Types**: `src/types.ts` – TypeScript interfaces and type definitions
- **Tests**: `src/__tests__/light-protocol-provider.test.ts` – Unit tests
- **Documentation**: `privacy-agent/docs/backend/light-protocol-integration.md` – Integration guide
...
- `privacy-agent/workspace/hubs/docs-hand-off.md` – Documentation migration notes
- `privacy-agent/strategy/product/technical-architecture.md` – Provider architecture section
- `privacy-agent/strategy/product/provider-comparison.md` – Comparison matrix
...
- **zkSDK Provider Comparison**: [/docs/zksdkjs/provider-comparison](/docs/zksdkjs/provider-comparison)
